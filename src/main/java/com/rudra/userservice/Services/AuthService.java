package com.rudra.userservice.Services;

import com.rudra.userservice.Exceptions.UserAlreadyExistsException;
import com.rudra.userservice.Exceptions.UserNotFoundException;
import com.rudra.userservice.Exceptions.WrongPasswordException;
import com.rudra.userservice.Models.Session;
import com.rudra.userservice.Models.User;
import com.rudra.userservice.Repositories.SessionRepository;
import com.rudra.userservice.Repositories.UserRepository;
...
public class AuthService {
    ...
    public String login(String email, String password) throws UserNotFoundException, WrongPasswordException {
        ...
        if (matches) {
            String token =  createJwtToken((long)userOptional.get().getId(),
                    new ArrayList<>(),
